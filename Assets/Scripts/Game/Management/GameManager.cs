...
public class GameManager : MonoBehaviour
{
    ...
    private void InitalizeGame()
    {
        ...
        Players = new GamePlayer[]
        {
            ...
            new GamePlayer(new PlayerProperties() { Controller = XboxController.Second, Name = "bob", InputType = InputType.Keyboard, Tank = Resources.Load("Properties/Tanks/TestTank") as TankProperties}, 1),
